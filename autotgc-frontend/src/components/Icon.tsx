/**
 * Icon — a dependency-free inline-SVG Lucide icon component.
 *
 * Renders Lucide (https://lucide.dev) glyphs as inline SVG so the app needs no
 * icon dependency. All icons share a 24×24 viewBox, 1.75 stroke, `currentColor`
 * stroke + no fill (a few decorative dots use fill="currentColor"), so an icon
 * inherits the surrounding text color and can be sized via the `size` prop.
 *
 * Usage:  <Icon name="layout-dashboard" size={18} />
 *
 * No emoji is used anywhere in the UI — every glyph comes from here.
 */
...
export interface IconProps {
  ...
  size?: number;
  className?: string;
  /** Lucide default stroke is 2; the brief specifies 1.75. */
  strokeWidth?: number;
  style?: CSSProperties;
